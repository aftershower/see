...
const SCAM_PATTERN = /(?:社保局|社安局|税务局|政府).{0,16}(?:转账|汇款|验证码|礼品卡|银行卡|密码|屏幕共享|保密|钱|现金)|(?:apple|google play|itunes|steam|target|walmart|amazon).{0,12}(?:礼品卡|gift card)|(?:陌生人|骗子|自称|客服|警察|公安|社保局|社安局|税务局|政府|有人|对方|让我|要求).{0,24}(?:安全账户|保护资金|保护资产|保护钱|资金安全)|(?:陌生人|骗子|自称|客服|警察|公安|社保局|社安局|税务局|政府|有人|对方|让我|要求).{0,16}(?:密码|银行密码)|(?:stranger|unknown caller|someone|somebody|caller).{0,30}(?:asked|told|needs?|wants?|demanded).{0,30}\bpin\b|(?:move|transfer|send).{0,24}(?:money|funds).{0,24}(?:safe account|protect)|(?:不确定|陌生人|骗子|自称|让我|要求).{0,12}链接|链接.{0,12}(?:骗子|陌生人|转账|验证码|下载|安全)|(?:陌生人|骗子|自称|让我|要求).{0,12}身份证|身份证.{0,12}(?:发给|转账|验证码)/i;
const ID_DOCUMENT_SCAM_PATTERN = /(?:(?:陌生人|骗子|自称|有人|对方|客服|警察|公安|社保局|政府|让我|要求|要我|叫我).{0,80}(?:身份证|身份证照片|身份证号码|证件照).{0,80}(?:发给|发送|拍给|传给|告诉|转发|上传|验证)|(?:身份证|身份证照片|身份证号码|证件照).{0,80}(?:发给|发送|拍给|传给|告诉|转发|上传|验证).{0,40}(?:陌生人|对方|客服|警察|公安|政府|他|她)|(?:stranger|unknown caller|someone|somebody|caller|they|he|she).{0,80}(?:send|share|upload|verify|confirm|photo|picture).{0,80}(?:id card|photo of my id|photo id|driver'?s license|passport|identity document)|(?:send|share|upload|verify|confirm).{0,80}(?:id card|photo of my id|photo id|driver'?s license|passport|identity document).{0,80}(?:stranger|unknown caller|someone|caller|chat|message))/i;
...
const DOWNLOAD_APP_SCAM_PATTERN = /(?:(?:陌生人|骗子|自称|有人|对方|客服|警察|公安|社保局|社安局|税务局|政府|stranger|unknown caller|someone|somebody|caller).{0,80}(?:下载|安装|download|install).{0,30}(?:app|软件|application)|(?:下载|安装|download|install).{0,30}(?:app|软件|application).{0,80}(?:屏幕共享|远程控制|remote access|screen sharing|自称|陌生人|caller|unknown caller))/i;
