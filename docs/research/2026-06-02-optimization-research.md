...
- FTC guidance says gift cards are for gifts, not payments; gift card, PIN, urgent-payment, government-impersonation, tech-support, and "do not tell anyone" payment requests should be treated as scams, and reports can be filed at ReportFraud.ftc.gov. Source: https://consumer.ftc.gov/articles/avoiding-and-reporting-gift-card-scams
...
- FTC refund and recovery guidance says refund offers become high risk when someone asks for upfront fees, financial information, hard-to-recover payment methods, or remote access; an ordinary merchant refund is not enough by itself. Source: https://consumer.ftc.gov/articles/refund-and-recovery-scams
- FTC cryptocurrency guidance distinguishes ordinary cryptocurrency knowledge or use from scam indicators such as demands to pay in cryptocurrency, guaranteed profits, online dating plus investment advice, or crypto payments to protect money. Source: https://consumer.ftc.gov/articles/what-know-about-cryptocurrency-scams
- FTC QR-code guidance says QR codes are also used for ordinary menus, parking, events, and flights, while unexpected QR-code messages, covered parking-meter codes, urgent account warnings, login prompts, and spoofed sites are scam indicators. Source: https://consumer.ftc.gov/consumer-alerts/2023/12/scammers-hide-harmful-links-qr-codes-steal-your-information
- FTC tech-support guidance says scammers often invent computer problems, ask for remote access, route users to fake refund pages, request bank or credit card information, or demand hard-to-recover payments; user-initiated trusted support remains a normal scenario. Source: https://consumer.ftc.gov/articles/how-spot-avoid-and-report-tech-support-scams
- FTC identity theft guidance treats personal-information requests from suspicious contacts as a risk surface, while legitimate user-initiated errands and forms are different from unknown requesters asking for documents or identifiers. Source: https://consumer.ftc.gov/features/identity-theft
...
- FTC-aligned contextual scam false-positive tuning now avoids a refund false positive, bare bitcoin/crypto mentions, ordinary QR code education, and user-initiated tech support calls, while still catching refund-plus-remote-access pressure, crypto upfront-fee or protect-money pressure, QR code payment/login prompts, and tech support remote-access or gift-card pressure.
- FTC-aligned everyday payment false-positive tuning now avoids a gift card birthday false positive, verification code self-login, routine transfer language, courier delivery mentions, user-initiated bank-card errands, and ordinary app downloads; it still catches someone asking for gift cards, verification codes, card numbers, suspicious transfers, fake-app downloads, or courier cash pickup.
- FTC-aligned everyday secrecy false-positive tuning now avoids a birthday surprise, confidentiality agreement, screen sharing lesson, and news mention of scammers triggering scam routing by themselves; it still catches secrecy plus payment pressure and screen sharing or remote access paired with unknown callers, fake support, bank-card checks, refunds, or verification-code pressure.
- FTC-aligned identity document false positive tuning now avoids ordinary ID photo errand and insurance form language, while still catching an unknown requester asking the user to send, upload, verify, or share an ID card, ID photo, passport, driver's license, or identity document.
- Bank app false positive tuning now avoids user-initiated bank app funds safety notices, transfer limit notices, and bank app download language, while still catching safe account and protect money scripts when a caller, stranger, fake agency, or customer-service impersonator pressures the user to move money.
- Impersonation context false positive tuning now avoids fictional police dialogue, news mention of customer service impersonation, and government website form download language by itself; impersonation routing still catches payment, code, screen sharing, suspicious app download, ID-document, and safe account pressure.
